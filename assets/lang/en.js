en_lang = {
    ...
    "Cert-GCP-DataEng": "Google Cloud certification - Professional Data Engineer ",
    ...
    "SF-explanation": "Most of these skills, which I have just listed, were learnt in two specific environment. The scout where i have participated in many group experiences in which the organisation, achievement of continuous goals, constant learning, and passing the acquired knowledge have been the day's order.<br> Another important, ever-present environment since the last years of primary school in which I always helped during the summer and sporadically during the school term (not always with great enthusiasm) was my father's business, a food packaging trader, a buzzing environment in which you are always in contact with all kinds of people from the stall at the local market to the import/export company.",
    ...
    // "SK-Visual Studio Code": "Experience: High</br> I have been working with VSCode for more than 6 years using quotinians to do everything.</br>I also did some small extensions for personal use.",
    ...
    "SK-gen": "I believe that at this time a complete list of skills would be long to both read and, above all, to compile for me. I know and have used most of the commercially relevant DBs and all the data management/archiving systems available on GCP. I have been programming since I was 15 on a daily basis (perhaps less frequently in the workplace due to the more managerial role) so I think I can learn a programming language decently in a week. I currently use Python and Java on a daily basis. Some of the frameworks I use a lot with a lot of knowledge are Apache Airlfow and Apache Beam.",
